...
![스크린샷, 2022-04-13 20-52-36.png](../../.gitbook/assets/스크린샷_2022-04-13_20-52-36.png)

• 이후 설치 과정에서 WIFI 연결 후 진행해야 OS 업데이트가 가능함

![스크린샷, 2022-04-13 21-15-42.png](../../.gitbook/assets/스크린샷_2022-04-13_21-15-42.png)

• 상기의 Ubuntu 설치 중 업데이트 다운로드 및 아래의 "그래픽과 와이파이 하드웨어, 플래시, MP3등의 추가 소프트웨어 설치" 부분 체크

* **하단의 체크박스를 체크함으로써 NVIDIA 독점드라이버도 자동설치됨**

![스크린샷, 2022-04-13 20-53-05.png](../../.gitbook/assets/스크린샷_2022-04-13_20-53-05.png)

• 초기의 분할해둔 파티션에 Ubuntu를 설치하기 위해 ‘**기타**’ 체크

![스크린샷, 2022-04-13 20-53-25.png](../../.gitbook/assets/스크린샷_2022-04-13_20-53-25.png)
...
![스크린샷, 2022-04-13 20-54-07.png](../../.gitbook/assets/스크린샷_2022-04-13_20-54-07.png)
...
![스크린샷, 2022-04-13 20-54-17.png](../../.gitbook/assets/스크린샷_2022-04-13_20-54-17.png)

* 도시 설정을 대한민국 or 서울로 설정 후 계속 클릭

![스크린샷, 2022-04-13 20-57-03.png](../../.gitbook/assets/스크린샷_2022-04-13_20-57-03.png)

• 사용자 설정 후 계속 클릭 (한글 안됨)

* username / pwd를 cmd 창에서 자주 입력을 해야 하니 간편한 것으로 설정하기를 권장

![스크린샷, 2022-04-13 21-13-14.png](../../.gitbook/assets/스크린샷_2022-04-13_21-13-14.png)

• 설치를 자동으로 진행

![스크린샷, 2022-04-13 21-13-27.png](../../.gitbook/assets/스크린샷_2022-04-13_21-13-27.png)

• 설치 완료 후 ubuntu 재시작하기

![스크린샷, 2022-04-13 21-13-39.png](../../.gitbook/assets/스크린샷_2022-04-13_21-13-39.png)

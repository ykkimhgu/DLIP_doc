...
2. Make sure you have `uproject` files are associated with Unreal engine
   ...
   * Open `Epic Game Launcher` -&gt; `Unreal Engine` -&gt; `Unreal Engine 4.24.x`
     ...
     ![epic1](https://github.com/ykkimhgu/DLIP_doc/tree/3298e5d2a4b6369e5cef7973dd93eef44ca7addf/images/epic1.jpg)

   * Associate `uproject` with Unreal engine

     ![epic1](https://github.com/ykkimhgu/DLIP_doc/tree/3298e5d2a4b6369e5cef7973dd93eef44ca7addf/images/epic2.jpg)
...
5. Make sure `Blocks` project is the startup project. Click the right mouse button and select `Startup project`.
   ...
   ![block1](https://github.com/ykkimhgu/DLIP_doc/tree/3298e5d2a4b6369e5cef7973dd93eef44ca7addf/images/block1.jpg)

6. Build configuration is set to `DebugGame_Editor` and `Win64`. Hit F5 to run.

   ![block2](https://github.com/ykkimhgu/DLIP_doc/tree/3298e5d2a4b6369e5cef7973dd93eef44ca7addf/images/block2.jpg)
...
7. Press the Play button in Unreal Editor and you will see something like in below video. Also see [how to use AirSim](https://github.com/Microsoft/AirSim/#how-to-use-it).
   ...
   [![Blocks Demo Video](https://github.com/ykkimhgu/DLIP_doc/tree/3298e5d2a4b6369e5cef7973dd93eef44ca7addf/images/blocks_video.png)](https://www.youtube.com/watch?v=-r_QGaxMT4A)
